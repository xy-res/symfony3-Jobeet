 ...
 */
class Affiliate extends \AppBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'categories', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'token', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Affiliate' . "\0" . 'createdAt'];
        }
