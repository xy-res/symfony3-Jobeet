...
//        $job_sensio_labs->setUpdateAt(new \DateTime('2017-10-10'));
//
...
//        $job_extreme_sensio->setUpdateAt(new \DateTime('2017-10-10'));
//
//        $job_expired = new Job();
...
//        $job_expired->setUpdateAt(new \DateTime('2017-10-10'));
//
